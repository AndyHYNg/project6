            ...
            <div className="sortByCount">
              <form action="" onChange={this.props.sortMovies}>
                <label htmlFor="sort" className="visuallyHidden">
                  Sort by highest or lowest movie count
                </label>
                <select name="movieLikeCount" id="count">
                  <option value="highestCount" defaultValue={true}>
                    Most Popular
                  </option>
                  ...
                  <div className="favButtonContainer">
                    ...
                    >
                      <i
                        ...
                        aria-label="Save movie to favourites."
                      />
                    </button>
                  </div>
                ) : (
                  // otherwise, render the running count indicator and remove movie button
                  <div className="buttonContainer">
                    <div className="runningCountContainer">
                      <p>
                        ...
                        <i
                          ...
                          aria-label="Number of people who liked this movie."
                        />
                      </p>
                    </div>
                    <button onClick={() => this.props.removeMovie(movie)}>
                      <i
                        ...
                        aria-label="Delete this movie from group."
                      />
                    </button>
                  </div>
                )}
